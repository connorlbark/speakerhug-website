...
export const Home = (props) => {
  ...
  return (
    <div className="home-page-container">
      ...
      <div style={{}}>
        <Link to="/about"><MatrixText text="about " length={width/18} speed={2} className="link1" ></MatrixText></Link>
        <Link to="/music"><MatrixText text="music " length={width/18} speed={3} className="link2"></MatrixText></Link>
        {/* <MatrixText text="art " length={width/18} speed={5} className="link3"></MatrixText> */}
        <Link to="/photos"><MatrixText text="photos " length={width/18} speed={3} className="link3"></MatrixText></Link>
        <Link to="/shows"><MatrixText text="shows " length={width/18} speed={2} className="link4"></MatrixText></Link>
